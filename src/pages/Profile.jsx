          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <Card className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  <span>Win Rate</span>
                  <Badge variant="outline" className={calculateWinRate() >= 50 ? 'text-green-600' : ''}>
                    {calculateWinRate()}%
                  </Badge>
                </div>
              </div>
            ...
            <Card className="p-6">
              ...
              {loading ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-sm text-gray-400">Start playing to see your game history here!</p>
                </div>
              ) : (
                <>
                        ...
                        <div className="flex justify-between items-start">
                          <div className="space-y-1">
                            ...
                            <div className="text-sm text-gray-600">
                              Answer: <span className="font-mono bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">
                                {game.answer}
                              </span>
                            </div>
